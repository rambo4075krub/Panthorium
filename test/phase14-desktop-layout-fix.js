...
assert(shell.includes('SPHERE_RADIUS * 0.02'), 'particle sphere should continuously ripple at 2 percent');
assert(shell.includes('SPHERE_RADIUS * 0.005'), 'user and admin speech should ripple at 0.5 percent');
...
assert(shell.includes('targetNoiseAmplitude > currentNoiseAmplitude ? 0.12 : 0.035'), 'speech ripple should return smoothly to the idle state');
