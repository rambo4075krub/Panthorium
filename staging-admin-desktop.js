...
const APPS=[
  ...
  {id:'external-youtube',icon:'▶️',label:'YouTube',openers:['PanthoriumExternalApps.openYoutube']},
  {id:'external-facebook',icon:'📘',label:'Facebook',openers:['PanthoriumExternalApps.openFacebook']},
  {id:'external-line',icon:'💬',label:'LINE',openers:['PanthoriumExternalApps.openLine']},
  {id:'external-tiktok',icon:'🎵',label:'TikTok',openers:['PanthoriumExternalApps.openTiktok']},
  {id:'external-instagram',icon:'📷',label:'Instagram',openers:['PanthoriumExternalApps.openInstagram']},
  {id:'external-x',icon:'𝕏',label:'X',openers:['PanthoriumExternalApps.openX']},
